...
In general, all layers propagate log probabilities. So in case you want to know about the 'raw'
probability, you simply pass the output of a layer through :math:`\exp`.

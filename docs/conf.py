...
# -*- coding: utf-8 -*-
#
# LibSPN documentation build configuration file, created by
# sphinx-quickstart on Tue May 31 17:32:15 2016.
#
...
# Markdown doesn’t support a lot of the features of Sphinx, like
...
# built documents.
#
# Get version from SCM using setuptools_scm
# - full version:
try:
    # See https://pypi.python.org/pypi/setuptools_scm
    # to understand why we need to use pkg_resources for this:
    release = get_distribution('libspn').version
...
latex_documents = [
    ('index', 'LibSPN.tex', 'LibSPN Documentation',
     'Andrzej Pronobis', 'manual'),
]
...
texinfo_documents = [
    ('index', 'LibSPN', 'LibSPN Documentation',
     'Andrzej Pronobis', 'LibSPN', 'One line description of project.',
     'Miscellaneous'),
]

...
class TestGraphWeights(TestCase):
    ...
    #     w3 = spn.Weights(tf.initializers.constant([0.4, 0.4, 1.2]), num_weights=3)
    #     # Multi sums
    #     w4 = spn.Weights(tf.initializers.constant(3), num_weights=3, num_sums=2)
    #     w5 = spn.Weights(tf.initializers.constant(0.3), num_weights=5, num_sums=3)
    #     w6 = spn.Weights(tf.initializers.constant([0.1, 0.2, 0.3, 0.4]), num_weights=1, num_sums=4)
    #     init1 = w1.initialize()
    ...
    #     assign2 = w2.assign([0.5] * 4)
    #     assign3 = w3.assign([5] * 5)

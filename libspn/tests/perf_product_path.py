...
class Ops:
    ...
    def product(inputs, num_input_cols, num_prods, inf_type, log=False,
                output=None):
    ...
    def perm_products(inputs, num_input_cols, num_prods, inf_type, log=False,
                      output=None):
    ...
    def products(inputs, num_input_cols, num_prods, inf_type, log=False,
                 output=None):
        num_inputs = len(inputs)
        # Create permuted indices based on number and size of inputs
        inds = map(int, np.arange(num_input_cols))
...
class PerformanceTest:
    ...
    def _true_output(self, inputs):
        ...
        for idx, p_inds in enumerate(permuted_inds_list):
